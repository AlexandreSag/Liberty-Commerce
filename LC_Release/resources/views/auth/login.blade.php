    ...
    <x-auth-card>
        ...
        <form method="POST" action="{{ route('login') }}">
            ...
            <div>
                ...
                <x-input id="email" class="block mt-1 w-full title_input" type="email" name="email" :value="old('email')" required autofocus />
            </div>

            <!-- Password -->
            <div class="mt-4 ">
                <x-label class="font_title" for="password" :value="__('Password')" />
